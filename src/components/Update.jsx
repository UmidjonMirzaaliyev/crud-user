...
function Update() {
  ...
  return (
    <div>
      <div className="create-form my-[-70px] flex justify-center items-center flex-col  min-h-[100vh]">
        <form onSubmit={(e) => handleUser(e)} className="flex flex-col gap-7">
          ...
          <h1 className="text-4xl mt-9 text-primary font-bold">Update User</h1>
